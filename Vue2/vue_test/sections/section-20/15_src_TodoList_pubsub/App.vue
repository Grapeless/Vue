...
export default {
    ...
    mounted() {
        ...
        this.pubIdOfSetIsDone = pubsub.subscribe('setIsDone',(msgName,arg)=>{
            this.setIsDone(arg)
        })
        this.pubIdOfDeleteItem = pubsub.subscribe('deleteItem',(msgName,arg)=>{
            this.deleteItem(arg)
        })
    ...
    beforeDestroy() {
        ...
        pubsub.unsubscript(this.pubIdOfSetIsDone)
        pubsub.unsubscript(this.pubIdOfDeleteItem)
    }
}
</script>
