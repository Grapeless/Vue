<template>
    <div>
        <h1>当前求和为：{{ sum }}</h1>
        <h3>十倍和：{{ $store.getters["CountAbout/multiSum"] }}</h3>
...
export default {
    ...
    computed: {
        ...
        // ...mapGetters('CountAbout',['multiSum'])
    },
    methods: {
        /*add() {
        ...
        ...mapMutations('CountAbout',{add:'ADD',subtract:'SUBTRACT'}),
        ...
        ...mapActions('CountAbout',['addAfter','addWhenOdd'])
    },
    mounted() {
